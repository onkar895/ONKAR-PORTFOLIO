      ...
      <div className='container mx-auto'>
        ...
        <div className='w-full bg-black/10 h-[70px] backdrop-blur rounded-full max-w-[560px] mx-auto px-5 max-sm:px-3 flex justify-between items-center text-2xl text-white/50'>
          ...
          <div className={IconStyle}>
            <Link to='home' className='cursor-pointer flex items-center justify-center hover:text-white'>
              <BiHomeAlt />
            </Link>
          </div>
          <div className={IconStyle}>
            <Link to='about' className='cursor-pointer flex items-center justify-center hover:text-white'>
              <BiUser />
            </Link>
          </div>
          <div className={IconStyle}>
            <Link to='services' className='cursor-pointer flex items-center justify-center hover:text-white'>
              <BsClipboardData />
            </Link>
          </div>
          <div className={IconStyle}>
            <Link to='work' className='cursor-pointer flex items-center justify-center hover:text-white'>
              <BsBriefcase />
            </Link>
          </div>
          <div className={IconStyle}>
            <Link to='contact' className='cursor-pointer flex items-center justify-center hover:text-white'>
              <LuContact />
            </Link>
          </div>
          <button className='btn text-sm cursor-pointer px-9 py-[10px] max-sm:hidden'>
