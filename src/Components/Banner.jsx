...
const Banner = () => {
  ...
  const Contact = 'bg-transparent border border-gray-600 hover:border-cyan-900 rounded-full px-8 py-2 flex items-center text-gradient text-sm cursor-pointer hover:brightness-200 shadow-[0_2px_0_-2px_#B855F9,0_5px_0_-4px_#F8829E,0_8px_16px_-3px_#42A6E3] transition-all ease-in-out duration-500'
          ...
          <div className='flex flex-col lg:gap-2 gap-4 max-sm:mt-10 max-sm:mx-auto lg:w-[80%] lg:pl-8 md:px-2 lg:px-0'>
            ...
            <div className="flex flex-col lg:items-start items-center md:gap-6 gap-8 w-full mx-auto">
              ...
              <div className='flex min-[1024px]:flex-nowrap min-[1024px]:gap-10 flex-wrap justify-between md:w-[70.2%] w-[100%] max-sm:gap-y-10 md:gap-y-5 lg:gap-y-0 py-2 cursor-pointer'>
                <NavLink to='https://drive.google.com/file/d/1lLnkVydJ7WPQkeLZA1XSIYkY1XHdnAUQ/view?usp=sharing' className='flex items-center gap-2 text-sm btn px-6 py-2 md:hidden hover:-translate-y-1.2 transition-all duration-500'>
                  <span>Resume</span>
