...
const Education = () => {
  return (
    <div className="lg:w-[33.33%] w-full shadow-inner shadow-cyan-600 hover:shadow-lg hover:shadow-cyan-300  bg-gradient-to-br from-transparent to-black/50 backdrop-blur rounded-xl py-6 px-5 overflow-hidden cursor-pointer hover:scale-95 transition-all duration-300">
