...
const WorkData = ({ info }) => {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="2000"
      className="lg:w-[26.8vw] lg:h-[55vh] w-[85vw] h-[38vh] md:w-[40vw] md:h-[30vh] cursor-pointer relative overflow-hidden group"
    >
      <div className='lg:w-[26.8vw] lg:h-[38vh] w-[85vw] h-[28vh] md:w-[40vw] md:h-[20vh] flex items-center justify-center shadow-inner shadow-cyan-800 backdrop-blur rounded-t-xl overflow-hidden hover:overflow-hidden cursor-pointer relative group'>
        <img
          src={info.img}
          alt={info.title}
          className="lg:w-[21vw] lg:h-[26vh] w-[72vw] h-[21vh] md:w-[32vw] md:h-[14vh] scale-[1.1] object-fit group-hover:scale-[1.4] rounded-xl transition-all shadow-lg shadow-cyan-600"
        />
