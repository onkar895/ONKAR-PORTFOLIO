...
const Footer = () => {
  return (
    <section data-aos="fade-up" data-aos-duration="2000" className='mx-auto md:px-12 w-full lg:h-[60vh] h-[55vh]'>
      <div className='flex max-sm:flex-col lg:justify-start justify-center items-center shadow-inner shadow-cyan-900 bg-transparent backdrop-blur-3xl rounded-xl h-full'>
