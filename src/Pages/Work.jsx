...
const Work = () => {
  return (
    <section data-aos="fade-up" data-aos-duration="2000" className='mx-auto md:px-24 lg:px-12 w-full h-full'>
      <div className='shadow-inner shadow-cyan-900 bg-transparent backdrop-blur-3xl rounded-xl py-8 hide-scrollbar'>
